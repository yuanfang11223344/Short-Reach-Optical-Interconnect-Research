...
| 路径 | 用途 |
|---|---|
| `报告/日报/` | 日报归档，文件名为 `YYYY-MM-DD.md`。 |
| `报告/周报/` | 周报归档，文件名为 `weekly-YYYY-WXX.md`。 |
| `维护文档/报告同步规则.md` | 报告跨位置同步规则、命名规则和校验命令。 |
| `维护规则.md` | 仓库维护规则、报告生成规则和 Git 同步规则。 |
...
- 每天上午 10:00 生成日报。
- 每周一上午 10:00 同时生成日报和周报：先生成当天日报，再生成本周周报；周报不能替代日报。
